...
const capreLogo = "/_app/immutable/assets/CapreLogo.D1I35Cfi.webp";
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div id="footer" class="footer" data-svelte-h="svelte-1vyqpfs"><div id="footer"><div id="footerContent"><div id="copyright"><img${add_attribute("src", capreLogo, 0)} alt="CaproLogo" id="footerLogo"> <p>© 2023 Capre</p></div> <div id="footerLinks"><ul id="linkList"><li id="linkItem"><a href="/#mainHeader"><p>Home</p></a></li> <li id="linkItem"><a href="/#about"><p>About</p></a></li> <li id="linkItem"><a href="/#listings"><p>Listings</p></a></li> <li id="linkItem"><a href="/#contact"><p>Contact</p></a></li></ul></div></div></div></div>`;
});
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div id="mainHeader" class="header"><div class="mainHeader"><a href="/" id="capreLogo" data-svelte-h="svelte-183psmw"><img id="capreHeader"${add_attribute("src", capreLogo, 0)} alt="capreLogo"></a> <div class="headerWords" data-svelte-h="svelte-16aramn"><h2 class="headerText">Vanessa Vega</h2> <p class="headerText">DRE 02227468</p> <a href="tel:+1-909-746-9872" class="headerText">(909)746-9872</a></div> <a href="#0;" id="hamDiv" data-svelte-h="svelte-1ddg370"><div id="hamburger1"></div> <div id="hamburger2"></div> <div id="hamburger3"></div></a></div> <ul id="navlist" class="navlist" data-svelte-h="svelte-1d2sjog"><li class="navitems"><a class="navText" href="/#about">About</a></li> <li class="navitems"><a class="navText" href="/#listings">Listings</a></li> <li class="navitems"><a class="navText" href="/#contact">Contact</a></li></ul> <ul id="navlist2" class="navlist"><li class="navitems"><a class="navText" href="/#about" data-svelte-h="svelte-1weowg8">About</a></li> <li class="navitems"><a class="navText" href="/#listings" data-svelte-h="svelte-16ye4zw">Listings</a></li> <li class="navitems"><a class="navText" href="/#contact" data-svelte-h="svelte-inyqh0">Contact</a></li></ul></div>`;
});
...
export {
  Footer as F,
  Header as H,
  activeListingsStore as a,
  soldListingsStore as s
};
